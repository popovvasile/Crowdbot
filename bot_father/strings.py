...
COMPLETE_CREATION_REQUEST = " Ты ещё не закончил с прошлым ботом. Доделай его или нажми ❌ /cancel, чтобы продолжить."
CANCEL_CREATION_REQUEST = " Чтобы завершить нажми ❌ /cancel "
WELCOME_MESSAGE_REQUEST = "Введи приветственное сообщение для твоих юзеров✌️. Не переживай, его можно потом поменять"
...
# BUTTONS
ADMIN_BUTTON = "ADMIN"
REMOVED_BUTTON = "REMOVED"
IS_DELETED_BUTTON = "IS_DELETED"
BOT_BUTTON = "BOT"
TOKEN_REQUEST_BUTTON = "TOKEN_REQUEST"
WRONG_TOKEN_BUTTON = "WRONG_TOKEN"
SELECT_ADMIN_TO_REMOVE_BUTTON = "SELECT_ADMIN_TO_REMOVE"
UNKNOWN_COMMAND_BUTTON = "UNKNOWN_COMMAND"
UNKNOWN_ACTION_BUTTON = "UNKNOWN_ACTION"
UNKNOWN_CHAT_BUTTON = "UNKNOWN_CHAT"
WRONG_EMAIL_BUTTON = "WRONG_EMAIL"
NO_BOTS_BUTTON = "NO_BOTS"
RETURNED_TO_MAIN_MENU_BUTTON = "_RETURNED_TO_MAIN_MENU"
COMPLETE_CREATION_REQUEST_BUTTON = "COMPLETE_CREATION_REQUEST"
CANCEL_CREATION_REQUEST_BUTTON = "CANCEL_CREATION_REQUEST"
WELCOME_MESSAGE_REQUEST_BUTTON = "WELCOME_MESSAGE_REQUEST"
OCCUPATION_REQUEST_BUTTON = "OCCUPATION_REQUEST"
NEXT_EMAIL_REQUEST_BUTTON = "NEXT_EMAIL_REQUEST"
YOU_ARE_THE_ONLY_ADMIN_BUTTON = "YOU_ARE_THE_ONLY_ADMIN"
COMMANDS_BUTTON = "COMMANDS"
ADMIN_EMAILS_REQUEST_BUTTON = "ADMIN_EMAILS_REQUEST"
CHOOSE_ACTION_BUTTON = "CHOOSE_ACTION"
WELCOME_BUTTON = "WELCOME"
NO_CONTEXT_BUTTON = "NO_CONTEXT"
BOT_READY_BUTTON = "BOT_READY"
SELECT_BOT_FOR_INFO_BUTTON = "SELECT_BOT_FOR_INFO"
SELECT_BOT_TO_MANAGE_BUTTON = "SELECT_BOT_TO_MANAGE"
ALL_BOTS_COMPLETED_BUTTON = "ALL_BOTS_COMPLETED"
BOT_DELETED_BUTTON = "BOT_DELETED"
# buttons
ADD_ADMINS_BUTTON = "ADD_ADMINS"
DELETE_ADMIN_BUTTON = "DELETE_ADMIN"
DELETE_BUTTON = "DELETE"
BACK_BUTTON = "BACK"
CREATE_NEW_BOT_BUTTON = "CREATE_NEW_BOT"
MY_BOTS_BUTTON = "MY_BOTS"
MANAGE_MY_BOTS_BUTTON = "MANAGE_MY_BOTS"
GET_BOTS_INFO_BUTTON = "GET_BOTS_INFO"
CANCEL_CREATION_BUTTON = "CANCEL_CREATION"
