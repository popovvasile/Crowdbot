...
class InstantRunoffPollHandler(BasePoll):
    def __init__(self):
        super(InstantRunoffPollHandler, self).__init__()

        self.name = "Order of preference"
    ...
    def run_election(self, candidates, votes, skip_index=0):
        ...
        while elected is None:
            counts = self.count_votes(votes, candidates, skip_index)
            ...
            if max_votes >= quota:
                ...
                if not candidates:
                    ...
                    return self.run_election(old_candidates, votes, skip_index=skip_index + 1)
        return elected

    def count_votes(self, votes, candidates, skip_index):
