...
class TieBreakInstantRunoffPollHandler(BasePoll):
    def __init__(self):
        super(TieBreakInstantRunoffPollHandler, self).__init__()
        self.name = "Instant runoff poll with fallback tie-breaking"
        self.desc = "Like instant runoff, but tries extra hard to break ties."
    ...
    def evaluation(self, poll):
        ...
        if votes:
            ...
            while elected is None:
                counts = self.count_votes(votes, candidates)
                ...
                if max_votes >= quota:
                    ...
                    if not candidates:
                        ...
                        for candidate in old_candidates:
                            tiered_vote = self.get_votes_per_rank(poll, candidate)
