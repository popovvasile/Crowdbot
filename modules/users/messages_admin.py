        ...
        for chat in chats2:
            if chat["chat_id"] != update.callback_query.message.chat_id:
                context.bot.send_message(chat["chat_id"],
                                         text=context.bot.lang_dict["you_have_a_message_from"]
            ...
            if "chat_id" in chat:
                ...
                for content_dict in context.user_data["content"]:
                    ...
                    if "video_note_file" in content_dict:
                        context.bot.send_video_note(chat["chat_id"],
                    ...
                    if "document_file" in content_dict:
                        if ".png" in content_dict["document_file"] or ".jpg" \
                            ...
                            context.bot.send_document(chat["chat_id"],
...
SEND_MESSAGE_ONLY_TO_ADMINS_HANDLER = ConversationHandler(
    ...
    states={
        ...
        MESSAGE_TO_USERS: [
            MessageHandler(Filters.all, SendMessageToAdminsOnly().received_message)],
