...
class CreateShopHandler(object):
    ...
    def handle_address(self, update, context):
        ...
        if "currency" in context.user_data:
            self.end_creation(update, context)
        ...
        if context.user_data["delivery"] and "delivery_fee" not in context.user_data:
            context.user_data["to_delete"].append(
                update.callback_query.message.reply_text(
                    context.bot.lang_dict["create_shop_str_14"].format(
    ...
    @staticmethod
    def end_creation(update, context):
        ...
        update.message.reply_text(context.bot.lang_dict["create_shop_str_8"])
