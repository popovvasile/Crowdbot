...
1-й шаг: зайдите в @botfather и введите /mybots.
Выберите своего бота и нажмите «Платежи». Выберите поставщика. \n
Мы советуем использовать «Stripe» для европейской карты (из-за низкого эквайринга). \n
