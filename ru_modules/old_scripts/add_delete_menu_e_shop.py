...
__admin_keyboard__ = [InlineKeyboardButton(text=create_button, callback_data="create_shop_button"),
                      InlineKeyboardButton(text=delete_button, callback_data="delete_shop_button"),
                      InlineKeyboardButton(text=edit_button_button, callback_data="edit_shop_button")]
