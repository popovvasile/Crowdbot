...
class ChatWorker(threading.Thread):
    ...
    def __init__(self, bot: utils.DuckBot, chat: telegram.Chat, *args, **kwargs):
        ...
        self.chatbot = chatbots_table.find_one({"bot_id": self.bot.id})
    ...
    def __add_credit_menu(self):
        ...
        # Telegram Payments
        if self.chatbot["credit_card_token"] != "":
            keyboard.append([telegram.KeyboardButton(strings.menu_credit_card)])  # TODO
    ...
    def __add_credit_cc(self):
        ...
        self.bot.send_invoice(self.chat.id,
                              ...
                              provider_token=self.chatbot["credit_card_token"],
                              # TODO take this from the database
                              start_parameter="tempdeeplink",
                              currency=self.chatbot["currency"],
                              prices=prices,
                              need_name=True,
                              need_email=True,
