...
from crowdbot_alive_checker import crowdbot_bots_table
...
def main():
    updaters = [tg.Updater(token["token"]) for token in crowdbot_bots_table.find()]
    for updater in updaters:
        ...
        # print(token)
        updater.start_polling(timeout=60, read_latency=60, clean=True, bootstrap_retries=50)
